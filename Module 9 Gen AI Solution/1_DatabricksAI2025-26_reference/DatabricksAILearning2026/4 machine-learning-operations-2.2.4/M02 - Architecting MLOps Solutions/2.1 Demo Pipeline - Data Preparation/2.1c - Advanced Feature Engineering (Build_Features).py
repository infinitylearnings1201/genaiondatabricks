...
for old_col in loan_df.columns:
    loan_df = loan_df.withColumnRenamed(old_col, old_col.lower())
...
# Save the updated DataFrame to Unity Catalog
loan_df.write.mode("overwrite").saveAsTable(feature_engineered_data_path)
