...
diabetes_table_name = f"mltraining.diabetes.diabetes_features"
...
fe.create_table(
    ...
    tags={"source": "bronze", "format": "delta", "owner": "akash.wadhankar@infocepts.com"}
)
...
diet_table_name = f"mltraining.diabetes.diet_features"
fe.drop_table(
