...
dataset_path = f"/Volumes/mltraining/datasets/files/diabetes/diabetes_binary_5050_raw.csv"
...
cdc_df_full_silver = f"mltraining.diabetes.cdc_df_full_silver"
...
train_df.write.mode("overwrite").option("overwriteSchema", True).saveAsTable(f"mltraining.diabetes.cdc_df_train")
test_df.write.mode("overwrite").option("overwriteSchema", True).saveAsTable(f"mltraining.diabetes.cdc_df_baseline")
...
pipeline_model.write().overwrite().save(f"/Workspace/Shared/1_DatabricksAI2025-26/DatabricksAILearning2026/pipelines")
...
loaded_pipeline = PipelineModel.load(f"/Workspace/Shared/1_DatabricksAI2025-26/DatabricksAILearning2026/pipelines")
