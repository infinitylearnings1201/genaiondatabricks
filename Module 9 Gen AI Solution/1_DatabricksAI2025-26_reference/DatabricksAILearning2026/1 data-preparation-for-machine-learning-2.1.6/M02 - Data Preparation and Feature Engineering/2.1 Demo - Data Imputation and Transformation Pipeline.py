...
dataset_path = f"/Volumes/mltraining/datasets/files/telco/telco-customer-churn-noisy.csv" # Full path
...
telco_customer_full_silver = "mltraining.telco.telco_customer_full_silver"
...
telco_imputed_df.write.mode("overwrite").saveAsTable(f"mltraining.telco.telco_imputed_silver")
...
train_df.write.mode("overwrite").option("overwriteSchema", True).saveAsTable(f"mltraining.telco.telco_customers_train")
test_df.write.mode("overwrite").option("overwriteSchema", True).saveAsTable(f"mltraining.telco.telco_customers_baseline")
