...
churn_data = spark.sql("SELECT * FROM mltraining.telco.telco_customer_churn")
display(churn_data)
...
features_table_path = f"mltraining.telco.telco_customer_features"
...
dataset = spark.read.table("mltraining.telco.telco_customer_churn")
