...
table_name = f"mltraining.text_data.ag_news"
...
workspace_client = WorkspaceClient()  # Ensure proper credentials are configured or use environment variables if needed
