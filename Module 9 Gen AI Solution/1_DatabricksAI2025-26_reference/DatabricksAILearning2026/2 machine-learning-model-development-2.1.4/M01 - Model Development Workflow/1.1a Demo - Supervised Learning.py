...
# MAGIC %sql
# MAGIC
# MAGIC select * from mltraining.housing.ca_housing limit 10

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC show create table mltraining.housing.ca_housing 

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE mltraining.housing.ca_housing_1 (
# MAGIC   id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
# MAGIC   longitude DOUBLE,
# MAGIC   latitude DOUBLE,
# MAGIC   housing_median_age DOUBLE,
# MAGIC   total_rooms DOUBLE,
# MAGIC   total_bedrooms DOUBLE,
# MAGIC   population DOUBLE,
# MAGIC   households DOUBLE,
# MAGIC   median_income DOUBLE,
# MAGIC   median_house_value DOUBLE,
# MAGIC   ocean_proximity STRING,
# MAGIC   CONSTRAINT pk_id PRIMARY KEY (id)
# MAGIC )
# MAGIC USING delta
# MAGIC COMMENT 'Created by the file upload UI'
# MAGIC TBLPROPERTIES (
...
# MAGIC %sql
# MAGIC INSERT INTO mltraining.housing.ca_housing_1 (
# MAGIC   longitude, latitude, housing_median_age, total_rooms, total_bedrooms,
# MAGIC   population, households, median_income, median_house_value, ocean_proximity
# MAGIC )
# MAGIC SELECT
# MAGIC   CAST(longitude AS DOUBLE),
# MAGIC   CAST(latitude AS DOUBLE),
# MAGIC   CAST(housing_median_age AS DOUBLE),
# MAGIC   CAST(total_rooms AS DOUBLE),
# MAGIC   CAST(total_bedrooms AS DOUBLE),
# MAGIC   CAST(population AS DOUBLE),
# MAGIC   CAST(households AS DOUBLE),
# MAGIC   CAST(median_income AS DOUBLE),
# MAGIC   CAST(median_house_value AS DOUBLE),
# MAGIC   CAST(ocean_proximity AS STRING)
# MAGIC FROM read_files(
# MAGIC   '/Volumes/mltraining/datasets/files/housing/ca-housing.csv',
# MAGIC   format => 'csv',
# MAGIC   header => true,
...
# MAGIC %sql
# MAGIC
# MAGIC select * from mltraining.housing.ca_housing_1 limit 10
# MAGIC
...
table_name = f"mltraining.housing.ca_housing_1"
