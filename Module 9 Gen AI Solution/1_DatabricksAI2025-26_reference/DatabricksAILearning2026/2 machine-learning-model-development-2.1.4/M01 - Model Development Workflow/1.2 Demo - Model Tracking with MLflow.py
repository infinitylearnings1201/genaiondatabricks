...
feature_dataset = mlflow.data.load_delta(
    table_name = f"mltraining.diabetes.diabetes_binary", 
    name = "diabetes_binary"
)   
feature_data_pd = feature_dataset.df.toPandas()
# Drop the 'unique_id' column
if "unique_id" in feature_data_pd.columns: feature_data_pd = feature_data_pd.drop("unique_id", axis=1)
...
#mlflow.set_experiment(f"/Workspace/Users/akash.wadhankar@infocepts.com/diabetes/")

# turn off autologging
mlflow.sklearn.autolog(disable=True)
model_name = f"mltraining.diabetes.diabetes-predictions"
